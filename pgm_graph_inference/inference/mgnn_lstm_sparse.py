...
class GGNN_LSTM(nn.Module):
    def __init__(self, state_dim, message_dim,hidden_unit_message_dim, hidden_unit_readout_dim, n_steps=10):
        ...
        self.var2fac_propagator = nn.LSTMCell(self.message_dim, self.state_dim)
        self.fac2var_propagator = nn.LSTMCell(self.message_dim, self.state_dim)
    ...
    def forward(self, J, b):
        ...
        var2fac_cell_state = torch.zeros(num_var2fac_msg_nodes, self.state_dim).to(device)
        fac2var_cell_state = torch.zeros(num_fac2var_msg_nodes, self.state_dim).to(device)
        ...
        for step in range(self.n_steps):
            ...
            var2fac_hidden_states, var2fac_cell_state = self.var2fac_propagator(node_messages, (var2fac_hidden_states, var2fac_cell_state))
            ...
            fac2var_hidden_states, fac2var_cell_state = self.fac2var_propagator(node_messages, (fac2var_hidden_states, fac2var_cell_state))
